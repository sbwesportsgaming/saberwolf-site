...
(function () {
  ...
  const formats = [
    ...
    },
    {
      ...
      features: ["Equipes de 4", "MVP básico com divisão única", "Equipes reais após check-in", "Escalações 3 + 1", "Team matches", "Pontuação 10/10/20/+10", "Playoffs SFL em escada"],
      requirements: ["Equipes reais confirmadas", "Check-in encerrado para preencher a tabela", "Elenco de 4 jogadores por equipe", "Divisão única no MVP básico", "Rodadas e confrontos por equipe", "Partida extra em caso de empate", "Top 4 real para playoffs SFL"],
      roadmap: ["Liberar criação controlada do MVP básico", "Preencher tabela somente com equipes reais após check-in", "Conectar confrontos e resultados reais", "Programar playoffs SFL Capcom", "Refinar painel operacional", "Expandir para modo avançado com múltiplas divisões"],
      specs: [
        ...
        { label: "Playoffs", value: "Padrão SFL Capcom: Top 4 em escada, FT50/FT70, sem partida extra" },
